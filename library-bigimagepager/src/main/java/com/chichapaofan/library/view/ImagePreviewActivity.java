...
import com.chichapaofan.library.ImagePreview;
import com.chichapaofan.library.R;
import com.chichapaofan.library.bean.ImageInfo;
import com.chichapaofan.library.glide.FileTarget;
import com.chichapaofan.library.glide.ImageLoader;
import com.chichapaofan.library.glide.progress.OnProgressListener;
import com.chichapaofan.library.glide.progress.ProgressManager;
import com.chichapaofan.library.tool.common.HandlerUtils;
import com.chichapaofan.library.tool.image.DownloadPictureUtil;
import com.chichapaofan.library.tool.ui.ToastUtil;
...
public class ImagePreviewActivity extends Activity implements Handler.Callback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_indicator.setText(
                String.format(getString(R.string.indicators), currentItem + 1 + "", "" + imageInfoList.size()));
    ...
    public void bt1ListView() {
        ...
        names.add("保存图片");
//        names.add("查看原图");
        dialog = new ButtomDialog(context, R.layout.dialog_exam_type,
                new int[]{R.id.btn_save, R.id.btn_check, R.id.btn_cancel, R.id.rl_cancel});
        dialog.show();
        dialog.setOnBottomItemClickListener(new ButtomDialog.OnBottomItemClickListener() {
            @Override
            public void onBottomItemClick(ButtomDialog dialog, View view) {
                if (view.getId() == R.id.btn_save) {//保存
                    downloadCurrentImg();
                } else if (view.getId() == R.id.btn_check) {//查看原图
