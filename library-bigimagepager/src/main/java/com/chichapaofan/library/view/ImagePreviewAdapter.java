...
import com.chichapaofan.library.tool.common.NetworkUtil;
import com.chichapaofan.library.tool.image.ImageUtil;
import com.chichapaofan.library.tool.ui.PhoneUtil;
import com.chichapaofan.library.tool.ui.ToastUtil;
import com.chichapaofan.library.view.helper.FingerDragHelper;
import com.chichapaofan.library.view.helper.ImageSource;
import com.chichapaofan.library.view.helper.SubsamplingScaleImageViewDragClose;
import com.chichapaofan.library.view.photoview.PhotoView;
            ...
            if (imageGifHashMap != null && imageGifHashMap.size() > 0) {
                for (Object o : imageGifHashMap.entrySet()) {
                    ...
                    if (entry != null && entry.getValue() != null) {
                        ...
                        ((PhotoView) entry.getValue()).setImageResource(0);
                    }
                }
