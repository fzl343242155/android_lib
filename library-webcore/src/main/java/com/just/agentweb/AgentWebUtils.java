...
public class AgentWebUtils {
	...
	private static String getMIMEType(File f) {
      ...
      /* 依扩展名的类型决定MimeType */
		...
		} else if ("m4a".equalsIgnoreCase(end) || "mp3".equalsIgnoreCase(end) || "mid".equalsIgnoreCase(end) ||
				"xmf".equalsIgnoreCase(end) || "ogg".equalsIgnoreCase(end) || "wav".equalsIgnoreCase(end)) {
			type = "audio/*";
		...
		} else if ("docx".equalsIgnoreCase(end) || "doc".equalsIgnoreCase(end)) {
			type = "application/vnd.ms-word";
		} else if ("xlsx".equalsIgnoreCase(end) || "xls".equalsIgnoreCase(end)) {
